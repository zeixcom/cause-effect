...
- [x] CE-005: Collapse the type vocabulary to shape × mutability — done ✓
  **Skill:** cause-effect-dev
...
- [x] CE-006: Introduce `createSignal` / `deriveSignal` and retire the composite façades — done ✓
  **Skill:** cause-effect-dev
...
- [x] CE-007: Move `watched` fully into options — done ✓
  **Skill:** cause-effect-dev
...
- [x] CE-008: Verify the core budget after the collapse — done ✓
  **Skill:** cause-effect-dev
