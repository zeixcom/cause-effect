...
import { createMemo, isMemo, type Memo } from './memo'
import { createSensor, type Sensor } from './sensor'
import { createState, isState, type State } from './state'
import { createTask, isTask, type Task } from './task'
...
const CELL_TYPES = new Set([TYPE_STATE, TYPE_MEMO, TYPE_TASK, TYPE_SENSOR])
 ...
 */
function isMutableCell<T extends {}>(value: unknown): value is MutableCell<T> {
