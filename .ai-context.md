...
- **Store**: Mutable signals for objects with individually reactive properties, with stable keys support for array-like stores
...
// Array-like stores with stable keys
const items = createStore(['apple', 'banana'], 'fruit')
...
const firstTodo = todoList.byKey('1')
