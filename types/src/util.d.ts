...
declare const isRecordOrArray: <T extends {
...
export { isString, isNumber, isFunction, isAsyncFunction, isObjectOfType, isRecord, isRecordOrArray, validArrayIndexes, hasMethod, isAbortError, toError, CircularDependencyError, };
