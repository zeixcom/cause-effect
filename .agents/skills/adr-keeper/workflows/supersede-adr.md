...
<success_criteria>
- New ADR is created with correct supersedes reference
- Old ADR status is updated to show it has been superseded
- Index is updated with both ADRs showing correct statuses
- New ADR is linked from old ADR and vice versa
- All ADR numbers remain sequential with no gaps
- Reason for supersession is clearly documented in the new ADR
</success_criteria>
