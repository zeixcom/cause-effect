...
2. ../shared/references/api-facts.md — API constraints and callback patterns
3. ../shared/references/non-obvious-behaviors.md — if the change touches graph edges, ownership, or reactive tracking
</required_reading>
