...
2. ../shared/references/api-facts.md — correct API usage, constraints, and callback patterns
3. ../shared/references/non-obvious-behaviors.md — avoid common pitfalls before writing any code
</required_reading>
...
Skim ../shared/references/non-obvious-behaviors.md for anything that applies to the task:
