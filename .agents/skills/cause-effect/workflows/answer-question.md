...
- API usage, call signatures, options → ../shared/references/api-facts.md
...
- Design rationale or constraints → references/signal-types.md + ../shared/references/api-facts.md
</required_reading>
...
|---|---|---|
| Which signal to use | "should I use", "difference between", "when to use", "State vs", "Memo vs" | references/signal-types.md |
| API usage / call signature | "how do I", "what does X return", "what are the options for", "how to create" | ../shared/references/api-facts.md |
| Unexpected behavior | "why does this not work", "is this a bug", "why is watched not firing", "not re-running" | ../shared/references/non-obvious-behaviors.md |
| Error meaning | "what does X error mean", "when is Y thrown", "getting RequiredOwnerError" | ../shared/references/error-classes.md |
| Design rationale | "why was X designed this way", "why no null", "why is T extends {}" | references/signal-types.md + ../shared/references/api-facts.md |
